<script>
    ...
    // Import Images
    let bgapp = "assets/img/apps.jpg";
    let hero = "assets/img/app/hero.png";
</script>

<section class="bg-half-260 pb-lg-0 pb-md-4 d-table w-100" style="background: url({bgapp}) no-repeat center;" id="home">
